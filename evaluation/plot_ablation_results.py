...
axs[0, 1].set_ylabel('Price (CNY/kWh)', fontsize=12)
...
axs[1, 1].plot(x_km, y_km, label='Daily Mileage PDF', linewidth=3)
axs[1, 1].set_title('Daily Mileage Distribution (Log-normal)', fontsize=14)
